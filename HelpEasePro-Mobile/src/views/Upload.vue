<template>
  <div>
    <van-nav-bar
        :title="submitType === 'video' ? '上传视频' : '撰写求助'"
        left-text="取消"
        :border="false"
        left-arrow
    ...
    <van-popup v-model="posterShow" round position="bottom" :style="{ height: '200px' }">
      <div style="padding: 20px;text-align: center">
        <div style="padding-bottom: 30px;letter-spacing: 1px;color: rgba(0,0,0, .7);font-weight: bold">选择求助封面</div>
